...
matter to us. Thank you for helping keep `netso` and its users safe.
...
- **Preferred:** GitHub private reporting — the **"Report a vulnerability"** button
  ...
  (<https://github.com/trustsentinel/netso/security/advisories/new>).
...
`netso` is pre-1.0: security fixes land on the latest `main` and the most recent
